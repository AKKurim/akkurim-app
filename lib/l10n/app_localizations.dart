...
abstract class AppLocalizations {
  ...
  /// The label for the sign up forms section
  ///
  /// In en, this message translates to:
  /// **'Sign Up Forms'**
  String get signUpForms;

  /// The label for the programme section
  ///
  /// In en, this message translates to:
  /// **'Programme'**
  String get programme;

  /// The label for the results section
  ///
  /// In en, this message translates to:
  /// **'Results'**
  String get results;

  /// The message shown when there are no results available
  ///
  /// In en, this message translates to:
  /// **'No results available'**
  String get noResults;

  /// The label for the discipline
  ///
  /// In en, this message translates to:
  /// **'Discipline'**
  ...
  /// The label for the edit group button
  ///
  /// In en, this message translates to:
  /// **'Edit Group'**
